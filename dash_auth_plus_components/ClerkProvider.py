...
- afterSignOutUrl (string; optional):
    ...
    @_explicitize_args
    def __init__(self, children=None, id=Component.UNDEFINED, PUBLISHABLE_KEY=Component.REQUIRED, afterSignOutUrl=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'id', 'PUBLISHABLE_KEY', 'afterSignOutUrl']
        self._valid_wildcard_attributes = []
        self.available_properties = ['children', 'id', 'PUBLISHABLE_KEY', 'afterSignOutUrl']
